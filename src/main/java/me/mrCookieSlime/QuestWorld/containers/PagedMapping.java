...
public class PagedMapping {
	...
	// TODO fix this "clearPages" nonsense, this is left over from the party menu having no support for going back
	// to the correct place (category picker vs quest picker). It should be "isNavButton" like above.
