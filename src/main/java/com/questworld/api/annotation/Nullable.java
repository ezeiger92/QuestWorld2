 ...
 * 
 * <p>
 * When used on a parameter, it indicates <tt>null</tt> is an acceptable
 * argument and the function will not blindly use that value without checking
 * against <tt>null</tt>.
 * 
 * <p>
 * When used on a function, it indicates <tt>null</tt> may be returned and the
 * user should check before using the value. If implementing a
