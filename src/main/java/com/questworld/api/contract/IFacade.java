...
public interface IFacade {
	/**
	 * Creates a new category. Note that strings must not be colorized beforehand,
	 * otherwise there will be undefined behavior.
	 * <p>
	 * As of writing this, {@link com.questworld.util.Text#wrap Text.wrap} fails to
	 * apply text colors correctly, but at any point it may be changed to throw an
	 * IllegalArgumentException or perform some other behavior.
	 * 
