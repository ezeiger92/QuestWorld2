...
public abstract class QuestExtension implements Reloadable {
	...
	/**
	 * When all dependencies are found, initialize is called. A handle to QuestWorld
	 * is given so that any custom events/listeners can be registered. All
	 * dependencies can be retrieved with {@link #getPlugins}, in the same order as
	 * {@link #getDepends}, after they have been found.
	 * <p>
	 * IMPORTANT: Do NOT try to register listeners from custom MissionTypes! This is
	 * handled by QuestWorld later! See {@link #getMissions} for more.
	 * 
	 ...
	 *             {@link QuestExtension#initialize initialize} will be passed up
	 *             the stack
	 */
	 ...
	 * <p>
	 * If a MissionType implements {@link org.bukkit.event.Listener Listener}, it
	 * will be automatically registered by QuestWorld after {@link #initialize} is
	 * called.
	 * 
