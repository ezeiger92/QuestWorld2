...
public class JsonFromLegacy {
	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] {
				...
				// Colors
				colorTest("0", "black"), colorTest("1", "dark_blue"), colorTest("2", "dark_green"),
				colorTest("3", "dark_aqua"), colorTest("4", "dark_red"), colorTest("5", "dark_purple"),
				colorTest("6", "gold"), colorTest("7", "gray"), colorTest("8", "dark_gray"), colorTest("9", "blue"),
				colorTest("a", "green"), colorTest("b", "aqua"), colorTest("c", "red"), colorTest("d", "light_purple"),
				colorTest("e", "yellow"), colorTest("f", "white"),

				// Format
				formatTest("k", "obfuscated"), formatTest("l", "bold"), formatTest("m", "strikethrough"),
				formatTest("n", "underline"), formatTest("o", "italic"),

				// Noise
				{ S + "0" + S + "1" + S + "2 noise ", "[{\"text\":\" noise \",\"color\":\"dark_green\"}]" },

				// Escaping
				textTest("\"quote\"", "\\\"quote\\\""), textTest("\\backslash\\", "\\\\backslash\\\\"), });
	}
